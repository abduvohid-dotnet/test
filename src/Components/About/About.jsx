        ...
        <section id="about" className="pt-24">
            <div className="container">
                <div>
                    ...
                    <div className="dark:text-[#898989] cursor-pointer font-sans px-[20px] py-[30px] w-full font-bold text-[#abadb2] text-[24px] mb-8 gap-[20px] justify-between flex flex-wrap items-strech">
                        <ul className="w-[45%]">
