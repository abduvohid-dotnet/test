            ...
            <div className="max-w-7xl mx-auto flex justify-between items-center py-4 px-6">
                ...
                <nav className="flex-1 items-center">
                    <ul className="flex justify-end space-x-6">
                        <li><a href="#home" className="dark:text-[#111827] block text-[#f7f3f3]">Home</a></li>
                        <li><a href="#about" className="dark:text-[#111827] block text-[#f7f3f3]">About</a></li>
                        <li><a href="#work" className="dark:text-[#111827] block text-[#f7f3f3]">Work</a></li>
                        <li><a href="#contact" className="dark:text-[#111827] block text-[#f7f3f3]">Contact</a></li>
                        <li>
