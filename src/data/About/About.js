const experienceData = [
    {
        id: 1,
        title: "UI Engineer at @Google",
        from: 2022,
        to: "Present",
        items: [
            {
                sign: ">",
                description: "Design and implementation of visually appealing and intuitive user interfaces for innovative technology products."
            },
            {
                sign: ">",
                description: "Continuous improvement of the user experience and maintenance of quality standards.",
            },
            {
                sign: ">",
                description: "Conducting testing and validation, user research, and collaborating with other teams to ensure quality and effective integration with the final product."
            }
        ]
    },
    {
        id: 2,
        title: "Frontend Developer at @Hashnode",
        from: 2020,
        to: 2022,
        items: [
            {
    ...
    {
        id: 3,
        title: "Software Engineer at @Oculus",
        from: 2018,
        to: 2020,
        items: [
            {
